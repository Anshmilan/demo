...
def categorize_dish(dish_name, dish_ingredients):
    ...
    Vegan_set=dish_ingredients.issubset(VEGAN)
    Vegetarian_set=dish_ingredients.issubset(VEGETARIAN)
    Paleo_set=dish_ingredients.issubset(PALEO)
    Keto_set=dish_ingredients.issubset(KETO)
    Omnivore_set=dish_ingredients.issubset(OMNIVORE)

    if Vegan_set is True:
        key='VEGAN'
    elif Vegetarian_set is True:
        key='VEGETARIAN'
    elif Paleo_set is True:
        key='PALEO'
    elif Keto_set is True:
        key='KETO'
    elif Omnivore_set is True:
        key='OMNIVORE'
