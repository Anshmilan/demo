...
def categorize_dish(dish_name, dish_ingredients):
    ...
    VEGAN_1=dish_ingredients.issubset(VEGAN)
    VEGETARIAN_1=dish_ingredients.issubset(VEGETARIAN)
    PALEO_1=dish_ingredients.issubset(PALEO)
    KETO_1=dish_ingredients.issubset(KETO)
    OMNIVORE_1=dish_ingredients.issubset(OMNIVORE)

    if VEGAN_1 is True:
        key='VEGAN'
    elif VEGETARIAN_1==True:
        key='VEGETARIAN'
    elif PALEO_1==True:
        key='PALEO'
    elif KETO_1==True:
        key='KETO'
    elif OMNIVORE_1 ==True:
        key='OMNIVORE'
